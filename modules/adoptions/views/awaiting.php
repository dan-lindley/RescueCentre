<?php
// modules/adoptions/views/awaiting.php
...
$adoptionPatients = adoptions_fetch_patients($pdo, 'For Adoption', $adoptionsCentreId);
?>
...
<div class="content-title">
    <div class="title">
        ...
        <div class="txt">
            <h2>Adoptions</h2>
            <p>Patients currently marked as available for adoption.</p>
        </div>
    </div>
</div>

<nav class="rc-tabs rc-tabs-pill" aria-label="Adoption views">
    <a class="rc-tab is-active" href="module.php?module=adoptions&view=awaiting">Awaiting Adoption (<?= (int)$adoptionCounts['For Adoption'] ?>)</a>
    <a class="rc-tab" href="module.php?module=adoptions&view=adopted">Adopted (<?= (int)$adoptionCounts['Adopted'] ?>)</a>
</nav>

<div class="rc-card">
    <h3>Awaiting Adoption</h3>
    <?php adoptions_render_patient_table($adoptionPatients, 'No patients are currently awaiting adoption.'); ?>
</div>
