...
<?=template_admin_header(
    ($lang['LM_RESIDENTS'] ?? 'My Residents') . ' - ' . $rescue_name . ' - Rescue Centre - Rescue Management System',
    'patients',
    'myresidents'
)?>
...
<div class="content-title">
    ...
    <div class="btns">
        <button id="wraBtn"
                ...
                class="btn grey"
                data-toggle="modal"
                data-target="#wraModal"
                data-toggle="tooltip"
                data-placement="top"
                title="<?= htmlspecialchars($lang['WRA_SCORE_EXPLAINED_TITLE'] ?? 'Wildlife Rapid Assessment Score Explained') ?>">
            <?= $lang['WRA_SCORE_EXPLAINED_BTN'] ?? 'WRA Score Explained' ?>
        </button>
    </div>
</div>

<?php include "views/my_residents_view.php"?>
