...
<section class="woocommerce-customer-details">
	...
	<h2 class="woocommerce-column__title"><?php esc_html_e( 'Billing address', 'woocommerce' ); ?></h2>
		...
		<table class="woocommerce-table woocommerce-table--order-details shop_table order_details down-table-brkk">
				<tr>
			...
			<h2 class="woocommerce-column__title"><?php esc_html_e( 'Shipping address', 'woocommerce' ); ?></h2>
				...
				<tr>
					...
					<?php if ( $order->get_shipping_phone() ) : ?>
						<td><p class="woocommerce-customer-details--phone"><?php echo esc_html( $order->get_shipping_phone() ); ?></p></td>
					<?php endif; ?>
				</tr>
				<tr>
					<td><strong>Email:</strong></td>
					<?php if ( $order->get_shipping_email() ) : ?>
						<td><p class="woocommerce-customer-details--email"><?php echo esc_html( $order->get_shipping_email() ); ?></p></td>
					<?php endif; ?>
				</tr>
		</table>
