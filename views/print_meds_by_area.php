...
<html>
<head>
<title>Medication Rounds – By Area</title>
<style>
body {
...
foreach ($grouped as $area => $times):
?>

<div class="print-card">
<div class="print-header">
    <?= htmlspecialchars($area) ?><br>
    <span style="font-size: 13px; font-weight: normal;"><?= $printDate ?></span>
</div>


    <?php foreach ($times as $time => $list): ?>
        <div class="print-subheader">
            <?= $time ?> — <?= roundLabel($time) ?>
        </div>
