...
<?php
	...
	<td class="align-middle"><?php echo $log; ?></td>
	<td class="align-middle"><?php echo $log_notes; ?> </td> </tr> <?php } ?> </tbody> </table>
                                               
<!-- Add Medication Button -->
<BR><button type="button" class="btn btn-success" data-toggle="modal" data-target="#partnerModal"> Add a log</button><br>