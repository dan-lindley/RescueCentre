	...
	<tbody>
		...
		foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
			...
			if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_checkout_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
					...
					<td class="product-image">
						<div class="brk--image">
							...
							<?php if( $_product->get_image_id() ): ?>
								<?php $listing_id=$cart_item['listing_id'][0]; 
				...
				<?php $adults= $cart_item['pricing']->guests;  
                      $children= $cart_item['pricing']->children;
				...
				<tr>
					<td></td>
					<td class="product-name">Adults x <?php echo $adults; ?></td>
					<td></td>
				</tr>
				<?php  } 
				...
				<tr>
					<td></td>
					<td class="product-name">Childs x <?php echo $children; ?></td>
					<td></td>
				</tr>
				<?php  } 
