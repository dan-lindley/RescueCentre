<?php
// modules/residents/views/residents.php
...
<?php require __DIR__ . '/my_residents_view.php'; ?>

<?php require dirname(__DIR__, 3) . '/controllers/form_handler.php'; ?>
