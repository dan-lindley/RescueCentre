...
$stmt = $pdo->prepare('SELECT COUNT(*) FROM accounts WHERE id = ? AND role IN ("Admin", "Developer")');
...
// Admin HTML links
    $admin_links = '
        <a href="../dashboard.php"' . ($selected == 'home' ? ' class="selected"' : '') . ' title="Dashboard">
            <span class="icon">
            ...
            <span class="txt">Back to Rescue</span>
        </a>
