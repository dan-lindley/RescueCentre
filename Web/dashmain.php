...
// Admin HTML links
    $admin_links = '
        <a href="dashboard.php"' . ($selected == 'dashboard' ? ' class="selected"' : '') . ' title="Dashboard">
            <span class="icon">
...
<a href="patients.php"' . ($selected == 'patients' ? ' class="selected"' : '') . ' title="Patient Menu">
            <span class="icon">
        ...
        <div class="sub">
            <a href="patients.php"' . ($selected == 'patients' && $selected_child == 'mypatients' ? ' class="selected"' : '') . '><span class="square"></span>My Patients</a>
            <a href="residents.php"' . ($selected == 'patients' && $selected_child == 'residents' ? ' class="selected"' : '') . '><span class="square"></span>Residents</a>
            <a href="patient_archive.php"' . ($selected == 'patients' && $selected_child == 'patientarchive' ? ' class="selected"' : '') . '><span class="square"></span>Archive</a>
            <a href=""' . ($selected == 'patients' && $selected_child == 'viewpatient' ? ' class="selected"' : '') . '><span class="square"></span>Individual Patient View</a>
        </div>

<a href="medication.php"' . ($selected == 'medication' ? ' class="selected"' : '') . ' title="Medication Menu">
            <span class="icon">
            ...
            <span class="txt">Medication</span>
            <span class="note">' . number_format($accounts_total) . '</span>
        </a>
        <div class="sub">
            <a href="medication.php"' . ($selected == 'medication' && $selected_child == 'mypatients' ? ' class="selected"' : '') . '><span class="square"></span>Medication Round</a>
            <a href="medication-round.php"' . ($selected == 'medication' && $selected_child == 'residents' ? ' class="selected"' : '') . '><span class="square"></span>Stock Management</a>
        </div>




        <a href="resources.php"' . ($selected == 'resources' ? ' class="selected"' : '') . ' title="Resources">
            <span class="icon">
        ...
        <a href="admin/settings.php"' . ($selected == 'settings' ? ' class="selected"' : '') . ' title="Settings">
            <span class="icon">
        ...
        <main class="responsive-width-100">
            <header>
                ...
                <div class="dropdown right">
                    <img src="languages/' . $lang['LANG_ICON'] . '" width="18px" height="18px">&nbsp; &nbsp;' . $lang['CURRENT_LANGUAGE'] . '
                    <div class="list">
                        <a href="index.php?lang=es"> <img src="languages/es.png" width="18px" height="18px"> &nbsp; &nbsp; Español</a>
                        <a href="index.php?lang=en"> <img src="languages/en.png" width="18px" height="18px"> &nbsp; &nbsp; English</a>
                    </div>
                        <div class="space-between"></div>
                <div class="dropdown right">
                    ' . $profile_img . '
                    <div class="list">
                        <a href="admin/account.php?id=' . $_SESSION['account_id'] . '">Edit Profile</a>
...
<script src="https://kit.fontawesome.com/4f9e11ce8c.js" crossorigin="anonymous"></script>
