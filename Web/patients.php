...
$page_css_files = ['core/css/patients.css'];
?>
<?=template_admin_header('My Patients - ' . $rescue_name . ' - Rescue Centre - Rescue Management System', 'patients', 'mypatients')?>
...
<?php include "views/my_patients.php"?>
