...
<div class="content-block">
    ...
    <div class="col-sm-10">
        <p style="text-align: right;"><?php echo $formatted_date; ?> </p>
        <?php echo $note_message; ?><br />
         Care note added by <strong><?php echo $note_author; ?></strong> <BR>Is this note visible to the public? <strong><?php echo $public ?></strong>
</div>  
</div>
</div>
		<?php } ?>	
